...
select * from roads where address like '여의도동%';

select * from tl_sprd_manage where rep_cn like '여의도동%';
...
select id, geom, source, target from roads_tlp where source > 137732 or target > 137732;
